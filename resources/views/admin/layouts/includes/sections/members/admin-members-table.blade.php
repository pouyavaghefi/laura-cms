<div class="row">
    <div class="col-sm-12">
        <div class="card-box table-responsive">
            <h4 class="header-title m-t-0 m-b-30">کاربران مدیر</h4>
            ...
            <table id="datatable" class="table table-striped table-bordered">
                ...
                @forelse($members as $member)
                    <tr>
                        ...
                        <td>@if(!empty($member->user->usr_last_login_at)) {{ digits_persian(jdate($member->user->usr_last_login_at)->ago()) }} @endif</td>
                        <td>
