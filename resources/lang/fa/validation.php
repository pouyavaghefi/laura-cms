...
return [
    ...
    */
    'attributes' => [
		...
		"tags" => "برچسب ها",
		"tag" => "برچسب",
		"mbr_cnt_id" => "کشور محل سکونت",
		"mbr_prv_id" => "استان محل سکونت",
		"mbr_cit_id" => "شهر محل سکونت",
		"mbr_gender_id" => "جنسیت",
		"mbr_national_code" => "کد ملی",
		"datep" => "تاریخ تولد",
		"mbr_phone" => "تلفن",
		"mbr_mobile" => "شماره موبایل",
		"mbr_secondary_email" => "ایمیل ثانویه",
		"mbr_fname" => "نام",
		"mbr_lname" => "نام خانوادگی",
		"mbr_en_fname" => "نام انگلیسی",
		"mbr_en_lname" => "نام خانوادگی انگلیسی",
		"mbr_nick_name" => "نام مستعار",
		"mbr_father_name" => "نام پدر",
		"mbr_postal_code" => "کد پستی",
		"mbr_address" => "آدرس",
